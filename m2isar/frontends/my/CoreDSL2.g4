...
expression
	...
	| left=expression bop=('*'|'/'|'%'|'s*'|'u*'|'su**') right=expression # binary_expression
	| left=expression bop=('+'|'-') right=expression # binary_expression
	| left=expression bop=('<<' | '>>' | 's<<' | 'u<<' | 'u>>') right=expression # binary_expression
	| left=expression bop=('<=' | '>=' | '>' | '<' | 'u<' | 'u>' | 's<' | 's>') right=expression # binary_expression
	| left=expression bop=('==' | '!=') right=expression # binary_expression
	| left=expression bop='&' right=expression # binary_expression
	| left=expression bop='^' right=expression # binary_expression
	| left=expression bop='|' right=expression # binary_expression
